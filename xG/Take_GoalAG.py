...
for i in range(1,15):
    ...
    for t in teams:
        ...
        xG_season_home.append(home_matches['goals_away'].sum())
        
        away_matches = df[df['away']==team]
        xG_season_away.append(away_matches['goals_home'].sum())
        
        xG_season_tot.append(home_matches['goals_away'].sum()+away_matches['goals_home'].sum())
...
df_xG_home.to_excel("goalsA_home_all.xlsx")
df_xG_away.to_excel("goalsA_away_all.xlsx")
df_xG_tot.to_excel("goalsA_tot_all.xlsx")
